...
const Register =({navigation}) =>{
    ...
    <View style={styles.container}>
        <Text style={{textAlign:'center',fontWeight:'400',fontSize:'30',color:'#953545',marginTop:200}}>Register</Text>
      ...
      <View style={{flexDirection:'row',gap:10,alignSelf:'center',marginTop:30}}>
        ...
        <Text onPress={() => navigation.navigate()} style={{color:'#953545'}}>Sign In</Text>
      </View>
    </View>
    )
}
